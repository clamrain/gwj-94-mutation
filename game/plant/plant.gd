...
func new_branch() -> Branch:
	...
	branch.color = Color(
		dna.get_polygene_value_as_float("stem_color_r"),
		dna.get_polygene_value_as_float("stem_color_g"),
		dna.get_polygene_value_as_float("stem_color_b"),
	)
	return branch
...
func animate_growth(b, t_b):
	...
	tween.tween_property(b, "scale", t_b.scale * subbranch_scale_multiplier, branch_growing_duration)
